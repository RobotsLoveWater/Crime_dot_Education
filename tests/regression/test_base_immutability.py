...
# tests/regression/test_base_immutability.py
#
...
#
# Runs through the compatibility entry point (`uv run python test_base_immutability.py`) or
# as a module (`uv run python -m tests.regression.test_base_immutability`), printing a report and exiting
