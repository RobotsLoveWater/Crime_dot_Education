...
# tests/regression/test_map_filter_equivalence.py
#
...
#
# Runs through the compatibility entry point (`uv run python test_map_filter_equivalence.py`) or
# as a module (`uv run python -m tests.regression.test_map_filter_equivalence`), printing a report and
